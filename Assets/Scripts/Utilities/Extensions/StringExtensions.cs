...
public static class StringExtensions
{
	...
	/// <summary>
	/// Convert string to the friendly case ( add space where upcase ).
	/// </summary>
	...
	/// <summary>
	/// Determines if is valid email address the specified s.
	/// </summary>
	...
	/// <summary>
	/// Determines if is valid IP address the specified s.
	/// </summary>
	/// <returns><c>true</c> if is valid email address the specified s; otherwise, <c>false</c>.</returns>
	/// <param name="s">S.</param>
	/// 
	...
	public static bool IsNumericR (this string s)
	{
	...
	public static bool HashCompare (this string s, string otherS)
	{
