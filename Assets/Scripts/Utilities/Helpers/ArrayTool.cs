...
/// <summary>
/// Fourni toutes les fonctions utiles pour manipuler les array à la manière du JavaScript
/// </summary>
public class ArrayTools
{
	...
	{
		return Shift<T> (array, indice, 1, 1);
	}
	...
	{
		return Shuffle<T> (array, 0, array.Length - 1);
	}
	...
	{
		return Sow<T> (array, value, count, 0, array.Length - 1, true);
	}
	...
	{
		return Update (array, selectFunc, 0, array.Length - 1);
	}
